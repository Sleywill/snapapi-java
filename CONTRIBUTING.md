# Contributing to the SnapAPI Java SDK
...
```bash
git clone https://github.com/Sleywill/snapapi-java.git
cd snapapi-java
```
...
Use the [Bug Report template](https://github.com/Sleywill/snapapi-java/issues/new?template=bug_report.md).
...
Use the [Feature Request template](https://github.com/Sleywill/snapapi-java/issues/new?template=feature_request.md).
...
Open a [Discussion](https://github.com/Sleywill/snapapi-java/discussions) or email support@snapapi.pics.
