...
public final class SnapAPIClient {
    ...
    private static String buildScreenshotJson(ScreenshotOptions o) {
        return new JsonBuilder()
            ...
            .field("isLandscape",       o.isIsLandscape() ? Boolean.TRUE : null)
            ...
            .field("scrollToBottom",    o.isScrollToBottom() ? Boolean.TRUE : null)
            ...
            .field("cookies",           o.getCookies())
            .field("httpAuth",          o.getHttpAuth())
            .field("proxy",             o.getProxy())
            .field("premiumProxy",      o.getPremiumProxy())
            .field("geolocation",       o.getGeolocation())
            .field("timezone",          o.getTimezone())
            .field("locale",            o.getLocale())
            .field("cache",             o.isCache() ? Boolean.TRUE : null)
            .field("cacheTtl",          o.getCacheTtl())
            .field("webhookUrl",        o.getWebhookUrl())
            .field("async",             o.isAsync() ? Boolean.TRUE : null)
